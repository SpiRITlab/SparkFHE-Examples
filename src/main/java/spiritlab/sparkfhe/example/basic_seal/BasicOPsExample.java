...
package spiritlab.sparkfhe.example.basic_seal;
...
public class BasicOPsExample {
    ...
    public static void main(String[] args) {
        ...
        // Start testing the basic operations in SEAL on plain text, such as addition, subtraction, and multiply.
        test_basic_op();

        // String testing the basic operations in SEAL on encrypted data, such as addition, subtraction, and multiply.
