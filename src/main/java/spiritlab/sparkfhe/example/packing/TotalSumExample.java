...
public class TotalSumExample {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("TIME_INFO:batch_FHE_total_sum_via_lambda:" + (endTime - startTime) + ":ms");

        startTime = System.currentTimeMillis();
        test_FHE_total_sum_via_native_code(spark, slices, library, scheme, pk_b, sk_b, rlk_b, glk_b);
        endTime = System.currentTimeMillis();
        System.out.println("TIME_INFO:batch_FHE_total_sum_via_native_code:" + (endTime - startTime) + ":ms");
