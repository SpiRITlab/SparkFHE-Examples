...
#./mvn -f pom-devel.xml exec:java -Dexec.mainClass=spiritlab.sparkfhe.example.batching.BasicOPsExample -Dexec.args="local HELIB CKKS gen/keys/my_public_key.txt gen/keys/my_secret_key.txt gen/records/$(ls gen/records | grep ptxt_long_0) gen/records/$(ls gen/records | grep ptxt_long_1)"
#
## run FHE dot product over two encrypted vectors
#./mvn -f pom-devel.xml exec:java -Dexec.mainClass=spiritlab.sparkfhe.example.batching.DotProductExample -Dexec.args="local HELIB CKKS gen/keys/my_public_key.txt gen/keys/my_secret_key.txt gen/records/$(ls gen/records | grep vec_a) gen/records/$(ls gen/records | grep vec_b)"
#
